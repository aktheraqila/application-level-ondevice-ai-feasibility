...
# Configuration - Matches your T5 benchmark exactly
DATASET_FOLDER = "dataset"
MODEL_DIR = "onnx_distilbart_fp32"
RESULT_FILE = "benchmark_distilbart_onnx_fp32.csv"
WARMUP_RUNS = 5
MEASURED_RUNS = 10
MIN_LENGTH = 20
MAX_LENGTH = 50
...
# ORTModelForSeq2SeqLM handles the optimized 'decoder_with_past' internally
model = ORTModelForSeq2SeqLM.from_pretrained(MODEL_DIR)

# Load dataset (Verified against your T5 logic)
articles = []
...
print(f"Starting ONNX benchmark on {len(articles)} articles...")
