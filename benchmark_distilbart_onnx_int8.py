...
MODEL_DIR = "onnx_distilbart_int8"
RESULT_FILE = "benchmark_distilbart_onnx_int8.csv"
WARMUP_RUNS = 5
MEASURED_RUNS = 10
MIN_LENGTH = 20
MAX_LENGTH = 50

print(f"Loading INT8 model from {MODEL_DIR}...")
...
print(f"Starting INT8 benchmark on {len(articles)} articles...")
